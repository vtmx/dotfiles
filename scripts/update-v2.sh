...
name="cmus"
src="$HOME/.config/cmus/onedarkv.theme"
dist="$DIST/cmus/onedarkv.theme"
path="$DIST/cmus"
update_file "$name" "$src" "$dist" "$path"

name="dolphin"
src="$HOME/.config/dolphinrc"
dist="$DIST/dolphin/dolphinrc"
path="$DIST/dolphin"
update_file "$name" "$src" "$dist" "$path"
...
src="$HOME/.config/vivaldi/Default/Bookmarks"
dist="$DIST/vivaldi/Bookmarks"
path="$DIST/vivaldi"
update_file "$name" "$src" "$dist" "$path"

...
# configs
alias ac='v $HOME/Dev/dotfiles/config/alacritty/alacritty.yml'
alias fc='v $HOME/Dev/dotfiles/config/fish/config.fish'
alias tc='v $HOME/Dev/dotfiles/config/.tmux.conf'
alias rc='v $HOME/Dev/dotfiles/config/rofi/config.rasi'
alias vc='v $HOME/Dev/dotfiles/config/nvim/init.lua'
alias vs='v $HOME/Dev/dotfiles/config/lua/settings.lua'
alias vm='v $HOME/Dev/dotfiles/config/nvim/lua/mappings.lua'
alias vp='v $HOME/Dev/dotfiles/config/nvim/lua/plugins.lua'
alias vt='v $HOME/Dev/dotfiles/config/nvim/lua/theme.lua'
